...
public class FileCollectTask extends AbstractCollectTask {
    ...
    protected Object getData() {
        ...
        if (ContextUtils.getBean(ReflectionUtils.tryClassForName("com.yh.csx.bsf.file.impl.HotFileProvider"), false) != null) {
            data.provider = "hotfile";
        } else if (ContextUtils.getBean(ReflectionUtils.tryClassForName("com.yh.csx.bsf.file.impl.QiniuFileProvider"),false) != null) {
            data.provider = "qiniu";
        }
